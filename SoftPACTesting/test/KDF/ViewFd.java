...
import framework.ExcelFileSheet;
import framework.KDTExecuter;
import framework.*;

public class ViewFd {
	WebDriver driver;
	String sheetname = "ViewFd";
	Sheet KDTexcelSheet;
	...
	@Test(dataProvider = "dataForTest", priority=9)
	public void registrationTest(String member) throws Exception {
